...
===========================================
00. Instala todas las herramientas
-------------------------------------------
1.  Instalar Nmap 
2.  Instalar Hydra
3.  Instalar SQLMap
...
11. Instalar Cupp
12. Instalar Instagram Bruteforcer (instahack)
13. Instalar Twitter Bruteforcer   (TwitterSniper)
14. Instalar Ubuntu
15. Instalar Fedora
16. Instalar viSQL
...
while loop:
    ...
    if what == "00":
        print("================================")
        print("Se va a instalar: nmap, hydra, sqlmap, metasploit, ngrok, angryFuzzer, red_hawk, weeman, IPGeoLocation, cupp, instahack, TwitterSniper, Hash-Buster, D-TECT, routersploit and viSQL with one click.")
        print("----------------")
        hm = input("[?] Quieres continuar? (y/n): ")
        print("================================")
        if hm == "y":
            print("========================================================")
            print("[+] Espera un poco")
            print("Esto puede tardar un poco no desesperes.")
            print("========================================================")
            ...
            print("[+] Hackea feliz como una perdiz      <3")
            print("========================================")
        else:
            rmenu = input("[?] Volver al menu? (y/n): ")
            if rmenu == "y":
                menu()
            else:
                break
